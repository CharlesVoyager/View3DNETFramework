...
namespace View3D.model
{
    ...
    public class OutRectPacker : RectPacker
    {
        ...
        public PackerRect platformSize;

        public OutRectPacker(int offset)
            : base(1, 1)
        ...
        public void SetPlatformSize(float w, float h)
        {
            addAtEmptySpotAutoGrow(new PackerRect(0, 0, (int)w, (int)h, null), _Offset * 2, _Offset * 2);
        }

        public bool addOutsideSpotAutoGrow(PackerRect pRect)
        {
            return addAtEmptySpotAutoGrow(pRect, _Offset * 2, _Offset * 2);
        }
    }
}
